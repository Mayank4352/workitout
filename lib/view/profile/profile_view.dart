...
class _ProfileViewState extends State<ProfileView> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async{
      DocumentSnapshot data = await users.doc(widget.user.uid).get();
      widget.userData = data.data() as Map<String, dynamic>;
      setState(() {
                ...
                children: [
                  Expanded(
                    child: TitleSubtitleCell(
                      title: "${widget.userData?["height"]}cm",
                      subtitle: "Height",
                    ),
                  ),
                  SizedBox(
                  ...
                  Expanded(
                    child: TitleSubtitleCell(
                      title: "${widget.userData?["weight"]}kg",
                      subtitle: "Weight",
                    ),
                  ),
                  SizedBox(
                  ...
                  Expanded(
                    child: TitleSubtitleCell(
                      title: widget.userData?["dateOfBirth"],
