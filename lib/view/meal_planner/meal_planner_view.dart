...
class MealPlannerView extends StatefulWidget {
  ...
  List? secondary = ["Item 1", "Item 2", "Item 3"];
...
class _MealPlannerViewState extends State<MealPlannerView> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance!.addPostFrameCallback((timeStamp) async{
      setState(() {
        widget.secondary = ["Item 1", "Item 2", "Item 3"];
      });
      widget.secondary = ["Item 1", "Item 2", "Item 3"];
      
      //widget.secondary = await Future.delayed(Duration(seconds: 2), () => ["Item 1", "Item 2", "Item 3"]);
    });
